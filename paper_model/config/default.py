...
_C.MODEL.NUM_CLASSES_ORDER_DISORDER = 2
_C.MODEL.NUM_CLASSES_PHASE = 2
_C.MODEL.NUM_CLASSES_MOL = 2
...
_C.DATASET = CN()
_C.DATASET.ROOT = ''
_C.DATASET.NUM_POINT = 20
_C.DATASET.PROCESS_DATA = False
_C.DATASET.USE_UNIFORM_SAMPLE = False
_C.DATASET.USE_NORMALS = True
_C.DATASET.DATASET = ''
_C.DATASET.LABELMAP = ''
